...
namespace EFCore.IRepository
{
    public interface IRepository<T> : IDisposable where T : class
    {
        ...
        /// <param name="isDesc">是否倒序</param>
        /// <returns></returns>
        System.Linq.IQueryable<T> Where<TOrder>(Expression<Func<T, bool>> @where, Expression<Func<T, TOrder>> order, int pageIndex, int pageSize, out int count, bool isDesc = false);
